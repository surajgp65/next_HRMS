...
const newPage = () => {
    ...
    const columns = useMemo(
      ...
      const handleAddButtonClick = () => {
        router.push('/pages/attendance/attendanceRequest/attendanceRequestForm/attendanceRequestForm');
      };
        ...
        <React.Fragment>
            ...
            <div className="page-content">
                <Container fluid={true}>
                    ...
                    <Button type="button" className="btn-sm" onClick={handleAddButtonClick}><i className="ri-add-line align-bottom me-1"></i>Add Attendance Request</Button>
                            ...
                            <Col lg={12}>
                                <Card id="apiKeyList">
                                    <Card.Header className="d-flex align-items-center">
                                        <h5 className="card-title flex-grow-1 mb-0">Attendance Request List</h5>
